...
public:
  ...
  CMediaSource() { m_iDriveType=SOURCE_TYPE_UNKNOWN; m_iLockMode=LOCK_MODE_EVERYONE; m_iBadPwdCount=0; m_iHasLock=0; m_ignore=false; m_allowSharing=true; m_enableCaching=false; };
  ...
  */
  ...
  bool m_enableCaching; // Enable file caching for source
};
